...
export default function InventoryCard({ productname, brand, weight, quantity, cft, category, handleClick, clientName }) {
    return (
        <>
            <div className='flex justify-center items-center mb-7'>
                <Grow in>
                    <div className='relative flex flex-col my-4 w-72 h-72 border p-4 shadow-md  bg-gray-200 border-gradient'>
